...
vim.g.vimwiki_list = {
  {
    ...
    index = 'chaos-sanctuary', -- The name of the index file.
    syntax = 'markdown', -- The syntax to be used for the wiki.
    ext = '.md', -- The file extension for the wiki files.
    diary_rel_path = 'daily-notes/', -- The relative path where diary files will be stored.
    diary_index = 'index', -- The name of the diary index file.
  }
}
